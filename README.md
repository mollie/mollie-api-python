...
> Looking for our most up-to-date Python SDK? We recommend migration to our [**new automatically generated Python SDK**](https://github.com/mollie/mollie-api-py/tree/main).  
