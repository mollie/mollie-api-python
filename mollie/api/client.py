...
class Client(object):
    ...
    def __init__(self, api_endpoint=None, timeout=2, retry=None):
        ...
        # Keep legacy formatting of the SSL component
        self.set_user_agent_component("OpenSSL", ssl.OPENSSL_VERSION.split(" ")[1], sanitize=False)
    ...
    def set_access_token(self, access_token):
        ...
        self.set_user_agent_component("OAuth", "2.0", sanitize=False)
